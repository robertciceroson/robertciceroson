...
|---|---|
| 📊 [**process-engineering-portfolio**](https://github.com/robertciceroson/process-engineering-portfolio) | 20 published BPMN swimlane/flowchart/VSM diagrams from federal DoD and commercial engagements (Army CID, Pentagon agencies, client process redesigns). |
| 📬 [**weekly-leadership-digest-automation**](https://github.com/robertciceroson/weekly-leadership-digest-automation) | Make.com multi-source automation — Notion + Slack + Calendar → Gemini AI synthesis → HTML executive digest. Replaces 3 hrs/week of manual Monday reporting. [Blueprint included](https://github.com/robertciceroson/weekly-leadership-digest-automation/blob/main/Executive-Report-Automation-Updated.json) |
...
| 🏠 [**Airbnb-Price-Prediction**](https://github.com/robertciceroson/Airbnb-Price-Prediction) | NYC Airbnb price prediction — end-to-end ML pipeline (XGBoost/Random Forest + EDA + interactive prediction interface, ~49K listings). [Live demo](https://airbnb-price-prediction-a9hyny92wfihme4mnzkzte.streamlit.app) |
